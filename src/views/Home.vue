        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad 2 introduce los fundamentos de programación: variables, constantes, estructuras condicionales y ciclos. Explica cómo declarar, utilizar y clasificar variables según su tipo, alcance y comportamiento. Detalla el uso de constantes para asegurar datos inmutables. Describe las estructuras condicionales (<em>if, else, switch</em>) para tomar decisiones lógicas, y los ciclos (<em>for, while, do-while</em>) para automatizar repeticiones. Se incluyen ejemplos en diversos lenguajes como Python, Java y C. Al finalizar, el estudiante podrá escribir código eficiente y comprender el flujo de control en la programación.
